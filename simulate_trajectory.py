...
from probability_model import get_probabilities
from probability_model_numba import get_probs_numba_wrapper
from probability_model_numba import dy_list, dx_list, w_list
...
def simulate_trajectory(
    ...
    while (calculate_distance(current_position, destination, PATHES_PARAMS, periodic_boundaries) > 0) and (t < t_max):
        ...
        if MODEL_PARAMS["zero_w2_at_finish"]:
            
            w2_here   = 0.0 if at_finish else MODEL_PARAMS_step["w_2"]
            MODEL_PARAMS_step["w_2"] = w2_here
